...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "@startersites/packages",\
        "reference": "workspace:."\
      },\
      {\
        "name": "@startersites/cli",\
        "reference": "workspace:packages/cli"\
      },\
      {\
        "name": "@startersites/styles",\
    ...
    "fallbackExclusionList": [\
      ["@startersites/cli", ["workspace:packages/cli"]],\
      ["@startersites/packages", ["workspace:."]],\
      ["@startersites/styles", ["workspace:packages/styles"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
